...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        // Correctly create the user object for the context
        ...
        // Call the context login function with the correct data
        login(userForContext, authData.token);
  ...
  const handleGoogleLogin = () => {
    toast.info('Tính năng đăng nhập Google sẽ được triển khai sớm!');
  };
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="glass-card p-8">
          ...
          >
            ...
            <span className="vietnamese-text">Đăng nhập với Google</span>
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-700 vietnamese-text">
                  Ghi nhớ đăng nhập
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-blue-600 hover:text-blue-500 vietnamese-text">
                  Quên mật khẩu?
                </a>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-white font-medium vietnamese-text ${loading
